...
export const TESTS = [
...

  {
    ...
    variables: [
      ...
      { key: 'lunghezzaArto', label: 'Lunghezza arto (ASIS → malleolo med.)', unit: 'cm' },
    ],
    ...
    guide: {
      ...
      protocol: [
        'LUNGHEZZA ARTO: misurare da ASIS (spina iliaca antero-superiore) al malleolo mediale in cm. Una sola misurazione — usare l\'arto dominante.',
        ...
        'Il sistema calcola automaticamente il Composite Score per ogni arto e ne restituisce la media.',
      ],
      notes: [
...

  {
    ...
    unit:       'cm',
    direction:  'direct',
    ageGroup:   (age) => age < 6 ? null : age <= 7 ? '6-7' : age <= 9 ? '8-9' : age <= 11 ? '10-11' : age <= 13 ? '12-13' : age <= 15 ? '14-15' : age <= 17 ? '16-17' : age <= 35 ? '18-35' : '36-50',
