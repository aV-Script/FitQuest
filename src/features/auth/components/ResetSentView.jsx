  ...
  return (
    <div className="text-center">
      <div
        ...
        style={{ background: 'rgba(14,196,82,0.1)', border: '1px solid rgba(14,196,82,0.25)' }}
      >
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none"
          stroke="var(--green-400)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button
        ...
        onMouseLeave={e => e.currentTarget.style.color = 'var(--green-400)'}
      >
        Torna al login
      </button>
    </div>
