...
export const TABLES = {
  ...
  // Youth 10-17: derivate da Zwicker et al. 2020 (Gait & Posture) — media ± SD → percentili normali
  // Nessun dato validato < 10 anni → calcPercentile restituisce null per età < 10
  // Fasce M e F identiche per youth (no dati normativi femminili specifici in letteratura)
  y_balance: {
    M: {
