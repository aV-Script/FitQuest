 ...
 *   sticky   — applica sticky top-0 z-20 con backdrop blur (default true)
 */
export function AppNav({ left, right, color, sticky = true }) {
  ...
  return (
    <nav className={`px-6 lg:px-10 py-4 border-b border-white/[.05] flex items-center ${sticky ? 'sticky top-0 z-20' : ''}`}    >
